 ...
 * account ledger tracks all account changes as determined by the metro.ledgerAccounts,
 * metro.ledgerLogUnconfirmed and metro.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than metro.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the metro.maxAPIRecords property
 ...
 *     <tr>
 *       <td>METRO_BALANCE</td>
 *       <td>Change in the MTR balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_METRO_BALANCE</td>
 *       <td>Change in the unconfirmed MTR balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws MetroException        Invalid request
     */
    @Override
