...
public final class Trade {
    ...
    private Trade(long assetId, Order.Ask askOrder, Order.Bid bidOrder) {
        ...
        this.priceMQT = isBuy ? askOrder.getPriceMQT() : bidOrder.getPriceMQT();
    }
    ...
    public long getPriceMQT() { return priceMQT; }
    ...
    public String toString() {
        return "Trade asset: " + Long.toUnsignedString(assetId) + " ask: " + Long.toUnsignedString(askOrderId)
                + " bid: " + Long.toUnsignedString(bidOrderId) + " price: " + priceMQT + " quantity: " + quantityQNT + " height: " + height;
    }
