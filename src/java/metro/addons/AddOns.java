...
import metro.Metro;
import metro.http.APIServlet;
import metro.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Metro.getStringListProperty("metro.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Metro.getBooleanProperty("metro.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Metro.isDesktopApplicationEnabled() ? "metrodesktop.policy" : "metro.policy");
