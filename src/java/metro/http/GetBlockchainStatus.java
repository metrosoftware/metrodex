...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Metro.APPLICATION);
        ...
        response.put("keyHeight", lastKeyBlock != null ? lastKeyBlock.getLocalHeight() + 1 : 0);
        ...
        response.put("coinbaseMaturityPeriodInKeyblocks", Consensus.COINBASE_MATURITY_PERIOD);
