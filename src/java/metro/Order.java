...
public abstract class Order {
    ...
    private static void matchOrders(long assetId) {
        ...
        while ((askOrder = Ask.getNextOrder(assetId)) != null
            ...
            if (askOrder.getPriceMQT() > bidOrder.getPriceMQT()) {
                break;
            }
            ...
            askAccount.addToBalanceAndUnconfirmedBalanceMQT(LedgerEvent.ASSET_TRADE, askOrder.getId(),
                            Math.multiplyExact(trade.getQuantityQNT(), trade.getPriceMQT()));
            ...
            bidAccount.addToBalanceMQT(LedgerEvent.ASSET_TRADE, bidOrder.getId(),
                            -Math.multiplyExact(trade.getQuantityQNT(), trade.getPriceMQT()));
            bidAccount.addToUnconfirmedBalanceMQT(LedgerEvent.ASSET_TRADE, bidOrder.getId(),
                            Math.multiplyExact(trade.getQuantityQNT(), (bidOrder.getPriceMQT() - trade.getPriceMQT())));
        }
    ...
    private Order(Transaction transaction, Attachment.ColoredCoinsOrderPlacement attachment) {
        ...
        this.priceMQT = attachment.getPriceMQT();
        this.creationHeight = Metro.getBlockchain().getHeight();
    ...
    public String toString() {
        return getClass().getSimpleName() + " id: " + Long.toUnsignedString(id) + " account: " + Long.toUnsignedString(accountId)
                + " asset: " + Long.toUnsignedString(assetId) + " price: " + priceMQT + " quantity: " + quantityQNT
    ...
    */
    ...
    public static final class Ask extends Order {
        ...
        public int compareTo(Ask o) {
            if (this.getPriceMQT() < o.getPriceMQT()) {
                return -1;
            } else if (this.getPriceMQT() > o.getPriceMQT()) {
                return 1;
            } else {
