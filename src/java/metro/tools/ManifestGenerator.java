...
import metro.Metro;
import metro.env.service.MetroService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/metro.manifest.mf", Metro.class.getCanonicalName(), "./lib");
        String serviceClassName = MetroService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/metroservice.manifest.mf", serviceClassName, "./lib");
    }
