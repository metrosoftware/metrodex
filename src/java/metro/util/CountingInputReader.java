...
import metro.MetroException.MetroIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws MetroIOException      Maximum count exceeded
     */
    private void incCount(long c) throws MetroIOException {
        count += c;
        if (count > limit)
            throw new MetroIOException("Maximum size exceeded: " + count);
    }
}
