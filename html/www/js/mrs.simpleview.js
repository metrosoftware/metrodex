...
var MRS = (function(MRS, $, undefined) {
     ...
     *      MRS.pages.my_page_name = function () {
     *          var view = MRS.simpleview.get('my_page_name_page', {
    ...
    MRS.simpleview = {
        ...
        get: function (element_id, scope) {
            ...
            MRS.simpleview.callbacks[element_id] = [];
    ...
    Handlebars.registerHelper('callback', function(view, fn) {
        ...
        var callbacks = MRS.simpleview.callbacks[view_id];
        var index = callbacks.length, self = this;
        callbacks.push(function (element) {
            fn.call(view, self, element);
        });
        return 'MRS.simpleview.callbacks.'+view_id+'['+index+'].call(null, $(this))';
    });
