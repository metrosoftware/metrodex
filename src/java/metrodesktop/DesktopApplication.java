...
public class DesktopApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        webEngine.setUserDataDirectory(Metro.getConfDir());
        ...
        loadWorker.stateProperty().addListener(
                (ov, oldState, newState) -> {
                    ...
                    mrs = (JSObject) webEngine.executeScript("MRS");
                    ...
                    Metro.getTransactionProcessor().addListener(transaction ->
        ...
        stage.getIcons().add(new Image(address + "/img/metro-icon-32x32.png"));
    ...
    private void updateClientState(String msg) {
        Platform.runLater(() -> webEngine.executeScript("MRS.getState(null, '" + msg + "')"));
    }
    ...
    private static String getUrl() {
        ...
        String defaultAccount = Metro.getStringProperty("metro.defaultDesktopAccount");
    ...
    private void download(String requestType, Map<String, String> params) {
        ...
        if (prunableMessage == null && retrieve) {
            try {
                if (Metro.getBlockchainProcessor().restorePrunedTransaction(transactionId) == null) {
