...
import metro.http.EventListener.PendingEvent;
 ...
 * metro.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than metro.apiEventTimeout.</li>
 * </ul>
 *
