...
import static metro.http.JSONResponses.MONITOR_ALREADY_STARTED;
 ...
 * <p>
 * A funding monitor will transfer MTR or ASSET from the funding account
 ...
 * <p>
 * MTR amounts are specified with 8 decimal places.  Asset decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws MetroException        Unable to process request
     */
    @Override
