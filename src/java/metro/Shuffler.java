...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Metro.getIntProperty("metro.maxNumberOfShufflers");
    ...
    private volatile MetroException.NotCurrentlyValidException failureCause;
    ...
    public MetroException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            ...
            if (participantAccount == null || transaction.getFeeMQT() > participantAccount.getUnconfirmedBalanceMQT()) {
                failedTransaction = transaction;
                failureCause = new MetroException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends MetroException {
