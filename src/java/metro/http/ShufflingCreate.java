...
public final class ShufflingCreate extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws MetroException {
        ...
        if (holdingType == HoldingType.MTR && amount < Constants.SHUFFLING_DEPOSIT_MQT) {
            return JSONResponses.incorrect("amount", "Minimum shuffling amount is " + Constants.SHUFFLING_DEPOSIT_MQT / Constants.ONE_MTR + " " + Constants.COIN_SYMBOL);
        }
