...
var MRS = (function(MRS, $, undefined) {
	MRS.forms.leaseBalanceComplete = function(response, data) {
		MRS.getAccountInfo();
	};
	...
	$("#lease_balance_modal").on("show.bs.modal", function() {
        ...
        leaseBalancePeriod.attr('max', MRS.constants.MAX_UNSIGNED_SHORT_JAVA);
		setLeaseBalanceHelp(MRS.constants.MAX_UNSIGNED_SHORT_JAVA);
	});

    $("#lease_balance_period").on("change", function() {
		if (this.value > MRS.constants.MAX_UNSIGNED_SHORT_JAVA) {
