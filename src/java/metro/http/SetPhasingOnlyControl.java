 ...
 *  <li>MQT(1) - only balance voting is allowed</li>
 ...
 *  <li>MQT(1) Metro balance threshold</li>
...
public final class SetPhasingOnlyControl extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest request) throws MetroException {
        ...
        long maxFees = ParameterParser.getLong(request, "controlMaxFees", 0, Constants.MAX_BALANCE_MQT, false);
