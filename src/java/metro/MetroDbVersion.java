        ...
        switch (nextUpdate) {
            case 1:
                apply("CREATE TABLE IF NOT EXISTS block (db_id IDENTITY, id BIGINT NOT NULL, version SMALLINT NOT NULL, "
                        ...
                        + "total_amount BIGINT NOT NULL, reward BIGINT NOT NULL, payload_length INT, "
                        ...
                        + "uncle_merkle_root BINARY(32), uncle_merkle_id BIGINT, halving_height INT, cluster_size SMALLINT)");
            case 2:
                apply("CREATE UNIQUE INDEX IF NOT EXISTS block_id_idx ON block (id)");
            case 3:
                //TODO create indices
                apply("CREATE TABLE IF NOT EXISTS uncle (db_id IDENTITY, id BIGINT NOT NULL, version SMALLINT NOT NULL, "
                        + "timestamp BIGINT NOT NULL, previous_block_id BIGINT, previous_key_block_id BIGINT, "
                        + "previous_block_hash BINARY(32), previous_key_block_hash BINARY(32), base_target BIGINT NOT NULL, "
                        + "nonce BIGINT, forgers_merkle_root BINARY(32), "
                        + "height INT NOT NULL, local_height INT NOT NULL, block_signature BINARY(64), "
                        + "tx_merkle_root BINARY(32), generator_id BIGINT NOT NULL, cluster_size SMALLINT, nephew_id BIGINT)");
            case 4:
