...
/**
 * Java LogManager extension for use with Metro
 */
public class MetroLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Metro log manager
     *
     ...
     * done terminating the Metro processes.
     */
    public MetroLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Metro shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Metro shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void mtrShutdown() {
        super.reset();
