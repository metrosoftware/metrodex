...
public final class PhasingParams {
    ...
    void validate() throws ValidationException {
        ...
        if (quorum <= 0 && voteWeighting.getVotingModel() != VoteWeighting.VotingModel.NONE) {
            throw new MetroException.NotValidException("quorum <= 0");
        }
        ...
        if (voteWeighting.getVotingModel() == VoteWeighting.VotingModel.ASSET) {
            ...
            if (quorum > asset.getInitialQuantityQNT()) {
                throw new MetroException.NotCurrentlyValidException("Quorum of " + quorum
            ...
            if (voteWeighting.getMinBalance() > asset.getInitialQuantityQNT()) {
                throw new MetroException.NotCurrentlyValidException("MinBalance of " + voteWeighting.getMinBalance()
                        + " exceeds total initial asset quantity " + asset.getInitialQuantityQNT());
            }
