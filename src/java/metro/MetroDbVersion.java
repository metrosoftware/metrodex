        ...
        switch (nextUpdate) {
            case 1:
                ...
                apply("CREATE TABLE IF NOT EXISTS block (db_id IDENTITY, id BIGINT NOT NULL, version SMALLINT NOT NULL, "
                        ...
                        + "next_block_id BIGINT, nonce INT, forgers_merkle_root BINARY(64), "
            ...
            case 31:
                apply("CREATE TABLE IF NOT EXISTS account (db_id IDENTITY, id BIGINT NOT NULL, id2 INT, "
            ...
            case 152:
                apply("CREATE INDEX IF NOT EXISTS account_last_forged_height_latest_idx ON account (latest, last_forged_height)");
            case 153:
