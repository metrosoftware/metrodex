...
public final class GetGuaranteedBalance extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws MetroException {
        ...
        if (account == null) {
            response.put("guaranteedBalanceMQT", "0");
        } else {
            response.put("guaranteedBalanceMQT", String.valueOf(account.getGuaranteedBalanceMQT(numberOfConfirmations, Metro.getBlockchain().getHeight())));
        }
