...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    DbIterator<? extends Transaction> getAllKeyBlockUnconfirmedTransactions();

    DbIterator<? extends Transaction> getAllPoSUnconfirmedTransactions();
    ...
    void broadcast(Transaction transaction) throws MetroException.ValidationException;

    void processPeerTransactions(JSONObject request) throws MetroException.ValidationException;
    ...
    List<Transaction> restorePrunableData(JSONArray transactions) throws MetroException.NotValidException;
}
