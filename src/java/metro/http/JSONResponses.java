...
public final class JSONResponses {
    ...
    public static final JSONStreamAware INCORRECT_ADMIN_PASSWORD = incorrect("adminPassword", "(the specified password does not match metro.adminPassword)");
    ...
    public static final JSONStreamAware MISSING_RECIPIENT_PUBLIC_KEY_IN_CHAIN = error("recipientPublicKey");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Administrator's password is not configured. Please set metro.adminPassword");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Poll results no longer available, set metro.processPolls=true and rescan");
