...
public class APIProxy {
    ...
    static final boolean enableAPIProxy = Constants.isLightClient ||
            (Metro.getBooleanProperty("metro.enableAPIProxy") && ! API.isOpenAPI);
    private static final long blacklistingPeriod = Metro.getIntProperty("metro.apiProxyBlacklistingPeriod");
    static final String forcedServerURL = Metro.getStringProperty("metro.forceAPIProxyServerURL", "");
    ...
    static boolean isActivated() {
        return Constants.isLightClient || (enableAPIProxy && Metro.getBlockchainProcessor().isDownloading());
    }
    ...
    boolean blacklistHost(String host) {
        ...
        blacklistedPeers.put(host, Metro.getEpochTime() + blacklistingPeriod);
