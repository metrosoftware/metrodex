...
package metro.http.twophased;

import metro.BlockchainTest;
import metro.Constants;
import metro.Metro;
import metro.http.APICall;
import metro.http.twophased.TestCreateTwoPhased.TwoPhasedMoneyTransferBuilder;
...
public class TestApproveTransaction extends BlockchainTest {
    ...
    public void validVoteCasting() {
        ...
        APICall apiCall = new TwoPhasedMoneyTransferBuilder()
                .finishHeight(Metro.getBlockchain().getHeight() + duration)
                .build();
        ...
        Assert.assertEquals(-50 * Constants.ONE_MTR - 2 * Constants.ONE_MTR, ALICE.getBalanceDiff());
        Assert.assertEquals(50 * Constants.ONE_MTR, BOB.getBalanceDiff());
    ...
    public void invalidVoteCasting() {
        ...
        Assert.assertEquals("ALICE balance: ", -2 * Constants.ONE_MTR, ALICE.getBalanceDiff());
    ...
    public void sendMoneyPhasedNoVoting() {
        ...
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_MTR - fee, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_MTR - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
