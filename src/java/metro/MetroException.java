...
public abstract class MetroException extends Exception {

    protected MetroException() {
        super();
    }

    protected MetroException(String message) {
        super(message);
    }

    protected MetroException(String message, Throwable cause) {
        super(message, cause);
    }

    protected MetroException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends MetroException {
    ...
    public static final class MetroIOException extends IOException {

        public MetroIOException(String message) {
            super(message);
        }

        public MetroIOException(String message, Throwable cause) {
            super(message, cause);
        }
