...
public class DividendPayment extends CreateTransaction {
    ...
    private DividendPayment() {
        super(new APITag[] {APITag.AE, APITag.CREATE_TRANSACTION}, "asset", "height", "amountMQTPerQNT");
    }
            ...
            throws MetroException
    {
        ...
        final long amountMQTPerQNT = ParameterParser.getAmountMQTPerQNT(request);
        ...
        final Attachment attachment = new Attachment.ColoredCoinsDividendPayment(asset.getId(), height, amountMQTPerQNT);
        try {
